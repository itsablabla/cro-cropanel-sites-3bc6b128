# Missing trust signals above fold — dev spec
Site: example.com · Priority 5 · High · Effort: Medium (2-5 days)

## Problem
The homepage lacks returns policy, guarantee, reviews, and security badges, failing to offset purchase risk for first-time visitors.
...
## Tracking
- Fire `cro_missing_trust_signals_above_fold` on interaction with the changed element
